...
#include "json.hpp" // If you have a compilation error here, see below
// You must download json.hpp in the following git repository: https://github.com/nlohmann/json
// and copy src/json.hpp to the same folder as this file.
// Alternatively, simply overwrite the include statement and this text block with the code
// found here: https://github.com/nlohmann/json/blob/develop/src/json.hpp
