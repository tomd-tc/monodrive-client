...
void  to_json(nlohmann::json& j, const Waypoint& v);
void  from_json(const nlohmann::json& j, Waypoint& v);
void  to_json(nlohmann::json& j, const ActorWaypoints& v);
void  from_json(const nlohmann::json& j, ActorWaypoints& v);
void  to_json(nlohmann::json& j, const ActorLane& v);
void  from_json(const nlohmann::json& j, ActorLane& v);
