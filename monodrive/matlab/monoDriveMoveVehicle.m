classdef monoDriveMoveVehicle < matlab.System & matlab.system.mixin.Propagates ...
    ...
    methods(Access = protected)
        ...
        function Count = stepImpl(obj, x, y, yaw)
            ...
            st = sts.SampleTime;
            msg = ego_pose_command(Time, x ,y ,yaw );
            obj.sim.step_vehicle(obj.sim.ID_REPLAY_STATE_SIMULATION_COMMAND, msg);
            Count = obj.Count;
        end
